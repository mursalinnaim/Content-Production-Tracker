...
import type { ContentPlan, ProjectGeneration } from '../types';
...
describe('ContentGeneration review interactions', () => {
    ...
    it('keeps entered edits and shows a save error when saving fails', async () => {
        ...
        expect(wrapper.text()).toContain('The draft could not be saved.');
        expect(
